const config = {
  ...
  "mainBox": {
    "summary": {
      ...
      "paragraphs": [
        ...
        "Through strategic negotiation and expert market positioning, we secured the perfect investment property. <strong>WON AGAINST 9 OTHER OFFERS</strong> in a fierce bidding war Secured immediate cash flow with premium tenants at top-dollar rent Gained instant equity position with property valued significantly above purchase price <strong>PURCHASED FOR $1,260,000</strong> on a strategically under-listed $999,000 property <strong>Key Victory Stats:</strong> <strong>9 COMPETING OFFERS DEFEATED</strong> <strong>IMMEDIATE POSITIVE CASH FLOW ACHIEVED</strong> <strong>3-5 YEAR EQUITY GROWTH PROJECTED</strong>"
      ]
    },
    "sidebar": {
      "image": {
  ...
  "sections": [
    ...
    },
    {
      ...
      "title": "The Results",
      "listItems": [
        "<strong>WON AGAINST 9 OTHER OFFERS</strong> in a fierce bidding war",
        ...
        "<strong>PURCHASED FOR $1,260,000</strong> on a strategically under-listed $999,000 property",
        "<strong>Key Victory Stats:</strong>",
        "<strong>9 COMPETING OFFERS DEFEATED</strong>",
        "<strong>IMMEDIATE POSITIVE CASH FLOW ACHIEVED</strong>",
        "<strong>3-5 YEAR EQUITY GROWTH PROJECTED</strong>"
      ]
    },
    {
      "type": "standard",
  ...
  "githubRepo": "https://github.com/arslvn93/Case-Study-132"
};
